...
class QQBinding(models.Model):
    user = models.OneToOneField(
        ...
        related_name="qq_binding",
    )
    main_character_id = models.BigIntegerField(
        null=True, blank=True, verbose_name="主角ID"
    )
    main_character_name = models.CharField(
        max_length=128, blank=True, verbose_name="主角名称"
    )
    corp_ticket = models.CharField(
        max_length=64, blank=True, verbose_name="军团Ticket"
    )
